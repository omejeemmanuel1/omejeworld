...
const Home = () =>{
  return (
    ...
    <section id="hero" name="home">
        <div className="overflow-hidden mx-auto container min-h-screen flex flex-col-reverse  pt-10 items-center px-6 space-y-0 md:space-y-0 font-pacifico md:flex-row">
