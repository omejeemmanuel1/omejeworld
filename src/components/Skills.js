...
const Skills = () => {
  ...
  return (
    <div  id="skills" name='skills' className='overflow-x-hidden w-full pt-[500px] h-[1100px] md:pt-[600px] md:h-[600px] md:min-h-screen  bg-[#f5f5f5]   md:pt-[100px] text-gray-300'>
      {/* Container */}
